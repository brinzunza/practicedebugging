...
export class QuestionService {
  ...
  getAllQuestions() {
    try {
      ...
      return questions.map(question => ({
        ...question,
        ...this.getProgress(question.id, progress)
  ...
  getProgress(questionId, progressArray) {
    const progressRecord = progressArray.find(p => p.question_id === questionId)
    return {
